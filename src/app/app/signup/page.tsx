...
function SignUp() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => setAlertMessage(''), 5000); //  alert hide  for 5 seconds
  };
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label
                htmlFor="name"
                className="block text-sm sm:text-lg font-medium text-gray-600"
              >
                Name
              </label>
              <input
            ...
            <button
              type="submit"
              className="w-full px-6 py-2 bg-red-500 text-white font-semibold rounded-md hover:bg-blue-600"
            >
              Create an Account
            </button>
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center px-6 py-2 border-2
               border-gray-300 text-gray-600 font-semibold rounded-md mt-4 hover:bg-gray-50-100"
            >
              <Image
