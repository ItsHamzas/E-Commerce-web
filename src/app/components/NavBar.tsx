    ...
    <div className="bg-violet-700 text-white py-2 text-sm">
      <div className="w-full max-w-[1200px] mx-auto flex items-center justify-between px-4 whitespace-nowrap">
        ...
        <div className="flex items-center gap-6">
          {/* Email */}
          <a href="hamzaahmed122333@gmail.com" className="flex items-center gap-2 hover:text-gray-200">
            <FaEnvelope />
            <span>hamzaahmed122333@gmail.com</span>
          </a>
          {/* Phone */}
          <a href="tel:(0123)456789" className="flex items-center gap-2 hover:text-gray-200">
            <FaPhoneAlt />
